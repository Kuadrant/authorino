...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataCaching) DeepCopyInto(out *MetadataCaching) {
	*out = *in
	out.Key = in.Key
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataCaching.
func (in *MetadataCaching) DeepCopy() *MetadataCaching {
	if in == nil {
		return nil
	}
	out := new(MetadataCaching)
