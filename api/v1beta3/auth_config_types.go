...
type OpaAuthorizationSpec struct {
	...
	// Version of the Rego language syntax used in the policy.
	// Defaults to "v0" for backward compatibility with existing policies, use "v1" to enable OPA v1.0 Rego syntax.
	// It is recommended to upgrade your policies and use v1 syntax, as v0 syntax is deprecated and may be removed in future releases of Authorino.
	// +kubebuilder:validation:Enum=v0;v1
	// +kubebuilder:default:="v0"
	RegoVersion string `json:"regoVersion,omitempty"`
}
