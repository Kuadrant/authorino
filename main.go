...
func registerCommonServerOptions(cmd *cobra.Command, opts *commonServerOptions) {
	...
	cmd.PersistentFlags().StringVar(&opts.pprofAddr, "pprof-bind-address", "", "The address the pprof endpoint binds to (disabled by default; set to an address such as :8084 to enable)")
