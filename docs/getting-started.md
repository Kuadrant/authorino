...
- [**Kubernetes**](https://kubernetes.io) server (minimum v1.30, recommended v1.35 or later), with permission to create Kubernetes Custom Resource Definitions (CRDs) (for bootstrapping Authorino and Authorino Operator)
