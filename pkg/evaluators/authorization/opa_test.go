...
func TestOPAInlineRego(t *testing.T) {
	opa, err := NewOPAAuthorization("test-opa", opaInlineRegoDataMock, &OPAExternalSource{}, false, opaParser.RegoV1, 0, context.TODO())
...
func TestOPAInlineRegoV0(t *testing.T) {
	...
	opa, err := NewOPAAuthorization("test-opa-v0", regoV0, &OPAExternalSource{}, false, opaParser.RegoV0, 0, context.TODO())
...
func TestOPAV1SyntaxFailsWithV0(t *testing.T) {
	opa, err := NewOPAAuthorization("test-opa-v1-as-v0", opaInlineRegoDataMock, &OPAExternalSource{}, false, opaParser.RegoV0, 0, context.TODO())
...
func TestOPAInlineRegoAndExternalUrl(t *testing.T) {
	...
	opa, err := NewOPAAuthorization("test-opa", opaInlineRegoDataMock, externalSource, false, opaParser.RegoV1, 0, context.TODO())
...
func TestOPAAllValues(t *testing.T) {
	...
	opa, _ := NewOPAAuthorization("test-opa", opaInlineRegoDataMock, &OPAExternalSource{}, true, opaParser.RegoV1, 0, context.TODO())
...
func BenchmarkOPAAuthz(b *testing.B) {
	...
	opa, _ := NewOPAAuthorization("test-opa", opaInlineRegoDataMock, &OPAExternalSource{}, false, opaParser.RegoV1, 0, context.TODO())
